...
export const BAND = {
  ...
  shows: {
    ...
    past: [
      ...
      { date: 'MAR 06 2025', venue: 'BOTTOM OF THE HILL', city: 'San Francisco, CA' },
      { date: 'DEC 21 2024', venue: 'LIGHTRAIL STUDIOS',  city: 'San Francisco, CA' },
      { date: 'DEC 11 2024', venue: 'HOTEL UTAH',         city: 'San Francisco, CA' },
      { date: 'DEC 06 2024', venue: 'THE DUBLINER',       city: 'San Francisco, CA' },
      { date: 'SEP 21 2024', venue: 'IRELANDS 32',        city: 'San Francisco, CA' },
      { date: 'SEP 13 2024', venue: 'OCEAN ALE HOUSE',    city: 'San Francisco, CA' },
      { date: 'AUG 02 2024', venue: 'HOTEL UTAH',         city: 'San Francisco, CA' },
      { date: 'JUL 26 2024', venue: 'THE DUBLINER',       city: 'San Francisco, CA' },
      { date: 'JUN 07 2024', venue: 'OCEAN ALE HOUSE',    city: 'San Francisco, CA' },
      { date: 'APR 26 2024', venue: 'OCEAN ALE HOUSE',    city: 'San Francisco, CA' },
      { date: 'MAR 03 2024', venue: 'OCEAN ALE HOUSE',    city: 'San Francisco, CA' },
      { date: 'JUL 15 2023', venue: 'THE BISTRO',         city: 'Hayward, CA' },
      { date: 'MAY 20 2023', venue: 'MAGARIAN BASEMENT',  city: 'Alameda, CA' },
    ] as Show[],
  },
  socials: [
